...
from src.agent_graph.tool_chinook_sqlagent import query_chinook_sqldb
from src.agent_graph.tool_travel_sqlagent import query_travel_sqldb
from src.agent_graph.tool_lookup_policy_rag import lookup_swiss_airline_policy
from src.agent_graph.tool_tavily_search import load_tavily_search_tool
from src.agent_graph.tool_stories_rag import lookup_stories
...
def build_graph():
    ...
    primary_llm = ChatGroq(model=TOOLS_CFG.primary_agent_llm,
                           temperature=TOOLS_CFG.primary_agent_llm_temperature)
